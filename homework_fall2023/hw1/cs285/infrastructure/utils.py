...
def sample_trajectory(env, policy, max_path_length, render=False):
    ...
    while True:
        ...
        ac = policy.forward(ptu.from_numpy(ob).unsqueeze(0)).sample() # HINT: this is a numpy array
        ac = ptu.to_numpy(ac) # convert to numpy array
        ac = ac[0] # this [0] here is because the policy supports returning a batch of actions, given a batch of states
